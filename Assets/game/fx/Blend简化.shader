...
Shader "-----ASE------/Blend简化"
{
	Properties
	{
		...
		[Toggle(_DISTORTIONINFLUENCEGRADIENT_ON)] _DistortionInfluenceGradient("DistortionInfluenceGradient", Float) = 0
		_DepthFadeIndensity("DepthFadeIndensity", Float) = 1
		[Toggle(_EAGEFADE_ON)] _EageFade("EageFade", Float) = 0
		_Eagefade("Eagefade", Float) = 1
		...
		[Toggle(_ALPHATEXUV2_ON)] _AlphaTexUV2("AlphaTexUV2", Float) = 0
		_AlphaU("AlphaU", Float) = 0
		_AlphaV("AlphaV", Float) = 0
		[Toggle(_SOFTDISSOLVESWITCH_ON)] _SoftDissolveSwitch("SoftDissolveSwitch", Float) = 0
		[Toggle(_DISTORTIONINFLUENCESOFT_ON)] _DistortionInfluenceSoft("DistortionInfluenceSoft", Float) = 0
		_SoftDissolveTex("SoftDissolveTex", 2D) = "white" {}
		[Toggle(_VERTEXCOLORINFLUENCESOFTDISSOLVE_ON)] _VertexColorInfluenceSoftDissolve("VertexColorInfluenceSoftDissolve", Float) = 0
		[Toggle(_CUSTOMDATAUV2XINFLUENCESOFTDISSOLVE_ON)] _CustomDataUV2XInfluenceSoftDissolve("CustomDataUV2XInfluenceSoftDissolve", Float) = 0
		...
		[Toggle(_DISTORTIONINFLUENCEOFFSET_ON)] _DistortionInfluenceOffset("DistortionInfluenceOffset", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature _DISTORTIONINFLUENCEOFFSET_ON
		#pragma shader_feature _DISTORTION2UV_ON
		#pragma shader_feature _DISTORTIONINFLUENCEGRADIENT_ON
		#pragma shader_feature _ALPHATEXUV2_ON
		#pragma shader_feature _DISTORTIONINFLUENCESOFT_ON
		#pragma shader_feature _VERTEXCOLORINFLUENCESOFTDISSOLVE_ON
		#pragma shader_feature _CUSTOMDATAUV2XINFLUENCESOFTDISSOLVE_ON
		#pragma shader_feature _EAGEFADE_ON
		...
		uniform float _VertexOffsetIndensity;
		uniform sampler2D _VertexOffsetTex;
		uniform float _VertexOffsetTexU;
		uniform float _VertexOffsetTexV;
		...
		uniform float _Alpha2U;
		uniform float _Alpha2V;
		uniform float4 _AlphaTex2_ST;
		uniform sampler2D _AlphaTex3;
		uniform float _Alpha3U;
		uniform float _Alpha3V;
		uniform float4 _AlphaTex3_ST;
		uniform sampler2D _AlphaTex4;
		uniform float _Alpha4U;
		uniform float _Alpha4V;
		uniform float4 _AlphaTex4_ST;
		uniform sampler2D _AlphaTex5;
		uniform float _Alpha5U;
		uniform float _Alpha5V;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float2 temp_output_169_0 = ( ( appendResult154 * _Time.y ) + uv0_VertexOffsetTex );
			...
			float2 uv1_DistortionTex = v.texcoord1.xy * _DistortionTex_ST.xy + _DistortionTex_ST.zw;
				...
				float2 staticSwitch38 = uv1_DistortionTex;
			#else
				float2 staticSwitch38 = uv0_DistortionTex;
			#endif
			float2 appendResult33 = (float2(_DistortionU , _DistortionV));
			float3 desaturateInitialColor43 = tex2Dlod( _DistortionTex, float4( ( staticSwitch38 + ( appendResult33 * _Time.y ) ), 0, 0.0) ).rgb;
			...
			float3 lerpResult172 = lerp( float3( temp_output_169_0 ,  0.0 ) , DistortionUV49 , DistortionIndeisty48);
				...
				float3 staticSwitch182 = lerpResult172;
			#else
				float3 staticSwitch182 = float3( temp_output_169_0 ,  0.0 );
			#endif
			float3 ase_vertexNormal = v.normal.xyz;
			v.vertex.xyz += ( _VertexOffsetIndensity * ( tex2Dlod( _VertexOffsetTex, float4( staticSwitch182.xy, 0, 0.0) ) * float4( ase_vertexNormal , 0.0 ) ) * v.color.a ).rgb;
		}
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float2 temp_output_162_0 = ( ( appendResult147 * _Time.y ) + uv0_GradientTex );
			...
			#endif
			float2 appendResult33 = (float2(_DistortionU , _DistortionV));
			float3 desaturateInitialColor43 = tex2D( _DistortionTex, ( staticSwitch38 + ( appendResult33 * _Time.y ) ) ).rgb;
			float desaturateDot43 = dot( desaturateInitialColor43, float3( 0.299, 0.587, 0.114 ));
			float3 desaturateVar43 = lerp( desaturateInitialColor43, desaturateDot43.xxx, 1.0 );
			float3 DistortionUV49 = desaturateVar43;
			float DistortionIndeisty48 = _DistortionIndensity;
			float3 lerpResult165 = lerp( float3( temp_output_162_0 ,  0.0 ) , DistortionUV49 , DistortionIndeisty48);
			#ifdef _DISTORTIONINFLUENCEGRADIENT_ON
				float3 staticSwitch173 = lerpResult165;
			#else
				float3 staticSwitch173 = float3( temp_output_162_0 ,  0.0 );
			#endif
			float2 appendResult107 = (float2(_MainU , _MainV));
			float2 uv0_MainTex = i.uv_texcoord * _MainTex_ST.xy + _MainTex_ST.zw;
			float3 lerpResult132 = lerp( float3( ( ( appendResult107 * _Time.y ) + uv0_MainTex ) ,  0.0 ) , desaturateVar43 , _DistortionIndensity);
			...
			float2 uv1_AlphaTex = i.uv2_texcoord2 * _AlphaTex_ST.xy + _AlphaTex_ST.zw;
				...
				float2 staticSwitch102 = uv1_AlphaTex;
			#else
				float2 staticSwitch102 = uv0_AlphaTex;
			#endif
			...
			float3 desaturateInitialColor139 = ( tex2D( _AlphaTex, ( ( appendResult82 * _Time.y ) + staticSwitch102 ) ) * tex2D( _AlphaTex2, ( ( appendResult84 * _Time.y ) + uv0_AlphaTex2 ) ) * tex2D( _AlphaTex3, ( ( appendResult90 * _Time.y ) + uv0_AlphaTex3 ) ) * tex2D( _AlphaTex4, ( ( appendResult88 * _Time.y ) + uv0_AlphaTex4 ) ) * tex2D( _AlphaTex5, ( ( appendResult94 * _Time.y ) + uv0_AlphaTex5 ) ) ).rgb;
			...
			float2 temp_output_53_0 = ( ( appendResult44 * _Time.y ) + uv0_SoftDissolveTex );
			float3 lerpResult54 = lerp( float3( temp_output_53_0 ,  0.0 ) , DistortionUV49 , DistortionIndeisty48);
				...
				float3 staticSwitch55 = lerpResult54;
			#else
				float3 staticSwitch55 = float3( temp_output_53_0 ,  0.0 );
			#endif
			float3 desaturateInitialColor63 = ( tex2D( _SoftDissolveTex, staticSwitch55.xy ) + _DissolveTexPlusValue ).rgb;
			...
			float3 desaturateVar63 = lerp( desaturateInitialColor63, desaturateDot63.xxx, 0.0 );
				...
				float staticSwitch66 = i.vertexColor.a;
			#else
				float staticSwitch66 = 1.0;
			#endif
			#ifdef _CUSTOMDATAUV2XINFLUENCESOFTDISSOLVE_ON
				float staticSwitch68 = ( i.uv_tex4coord.z * _CustomDataUV2X_Indensity );
			#else
				float staticSwitch68 = 1.0;
			#endif
			float clampResult115 = clamp( ( (( ( desaturateVar63 * staticSwitch66 ) * staticSwitch68 )).x + 1.0 + ( _SoftDissolveIndensity * -2.0 ) ) , 0.0 , 1.0 );
			...
			o.Emission = ( float4( ( ( (tex2D( _GradientTex, staticSwitch173.xy )).rgb * pow( ( (tex2DNode144).rgb * (_Color).rgb * (i.vertexColor).rgb * temp_output_151_0 ) , temp_cast_7 ) ) * _Indensity ) , 0.0 ) + ( DissolveLine168 * _LineColor * _LineIndensity ) ).rgb;
			float temp_output_157_0 = ( ( tex2DNode144.a * _Color.a * i.vertexColor.a ) * temp_output_151_0 );
			float temp_output_164_0 = pow( temp_output_157_0 , _OpacityPower );
			#ifdef _SOFTDISSOLVESWITCH_ON
				float staticSwitch211 = ( temp_output_164_0 * smoothstepResult125 );
			#else
				float staticSwitch211 = temp_output_164_0;
			#endif
			float OpacityGroup166 = temp_output_157_0;
			float temp_output_200_0 = ( ( staticSwitch211 + ( DissolveLine168 * OpacityGroup166 ) ) * _Opacity );
			float4 ase_screenPos = float4( i.screenPos.xyz , i.screenPos.w + 0.00000000001 );
			float4 ase_screenPosNorm = ase_screenPos / ase_screenPos.w;
			ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
			float screenDepth192 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
			float distanceDepth192 = abs( ( screenDepth192 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _DepthFadeIndensity ) );
			float clampResult193 = clamp( distanceDepth192 , 0.0 , 1.0 );
			#ifdef _DEPTHFADE_ON
				float staticSwitch213 = ( temp_output_200_0 * clampResult193 );
			#else
				float staticSwitch213 = temp_output_200_0;
			#endif
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 ase_worldNormal = i.worldNormal;
			float fresnelNdotV235 = dot( ase_worldNormal, ase_worldViewDir );
			float fresnelNode235 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV235, _Eagefade ) );
			#ifdef _EAGEFADE_ON
				float staticSwitch216 = ( staticSwitch213 * saturate( ( 1.0 - fresnelNode235 ) ) );
			#else
				float staticSwitch216 = staticSwitch213;
			#endif
			o.Alpha = staticSwitch216;
		}
...
/*ASEBEGIN
Version=17800
0;44;2048;1047;3150.033;171.0253;1;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;31;-6721.185,-843.0826;Float;False;Property;_DistortionV;DistortionV;17;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;32;-6721.185,-923.0825;Float;False;Property;_DistortionU;DistortionU;16;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-8440.996,1994.923;Float;False;Property;_SoftDissolveTexU;SoftDissolveTexU;33;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;-8437.996,2071.923;Float;False;Property;_SoftDissolveTexV;SoftDissolveTexV;34;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-5621.224,-245.879;Float;False;Property;_DistortionIndensity;DistortionIndensity;18;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-7302.015,2371.448;Float;False;Property;_DissolveTexPlusValue;DissolveTexPlusValue;32;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;57;-6887.082,1970.972;Inherit;True;Property;_SoftDissolveTex;SoftDissolveTex;28;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-7489.707,3089.502;Float;False;Property;_CustomDataUV2X_Indensity;CustomDataUV2X_Indensity;31;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;9;-6317.211,103.3005;Inherit;False;1701.067;1756.287;一堆Alpha;39;151;139;135;131;130;129;128;124;120;119;117;114;113;112;104;103;102;100;99;97;94;93;90;89;88;87;86;84;82;81;78;76;75;74;73;72;71;70;69;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.StaticSwitch;66;-7288.896,2564.042;Float;False;Property;_VertexColorInfluenceSoftDissolve;VertexColorInfluenceSoftDissolve;29;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;74;-6263.681,1243.586;Float;False;Property;_Alpha4V;Alpha4V;49;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;72;-6249.613,165.9184;Float;False;Property;_AlphaU;AlphaU;24;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-6259.984,489.334;Float;False;Property;_Alpha2U;Alpha2U;42;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;78;-6254.252,819.05;Float;False;Property;_Alpha3U;Alpha3U;45;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;70;-6266.681,1166.587;Float;False;Property;_Alpha4U;Alpha4U;48;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-6264.211,1577.88;Float;False;Property;_Alpha5V;Alpha5V;52;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;68;-7051.96,2923.511;Float;False;Property;_CustomDataUV2XInfluenceSoftDissolve;CustomDataUV2XInfluenceSoftDissolve;30;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;75;-6267.211,1500.881;Float;False;Property;_Alpha5U;Alpha5U;51;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-6246.613,242.9186;Float;False;Property;_AlphaV;AlphaV;25;0;Create;True;0;0;False;0;0;0.39;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;71;-6251.252,896.0501;Float;False;Property;_Alpha3V;Alpha3V;46;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-6256.984,566.333;Float;False;Property;_Alpha2V;Alpha2V;43;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;95;-6006.19,-619.156;Float;False;Property;_MainU;MainU;20;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-6003.191,-542.1563;Float;False;Property;_MainV;MainV;21;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-6168.997,2343.29;Float;False;Property;_SoftDissolveIndensity;SoftDissolveIndensity;35;0;Create;True;0;0;False;0;0;0;0;1.05;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;102;-6252.442,367.4877;Float;False;Property;_AlphaTexUV2;AlphaTexUV2;23;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;106;-5358.726,2316.116;Float;False;Property;_SoftDissolveSoft;SoftDissolveSoft;36;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;129;-5633.905,1491.475;Inherit;True;Property;_AlphaTex5;AlphaTex5;50;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;130;-5624.039,153.3008;Inherit;True;Property;_AlphaTex;AlphaTex;22;0;Create;True;0;0;False;0;-1;None;20d77a6773295684eb7590248691ff22;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;131;-5629.057,805.615;Inherit;True;Property;_AlphaTex3;AlphaTex3;44;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;124;-5642.407,1147.947;Inherit;True;Property;_AlphaTex4;AlphaTex4;47;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;128;-5628.887,483.306;Inherit;True;Property;_AlphaTex2;AlphaTex2;41;0;Create;True;0;0;False;0;-1;None;b35534797ace1064a8b26c38a5062d98;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;134;-4137.483,2096.175;Float;False;Property;_LineWidth;LineWidth;38;0;Create;True;0;0;False;0;0.1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;140;-5029.747,-434.8525;Float;False;Property;_Color;Color;11;1;[HDR];Create;True;0;0;False;0;1,1,1,1;1.844303,1.221411,0.4152094,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.VertexColorNode;138;-5024.118,-137.6051;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;146;-3951.892,2317.811;Float;False;Property;_LineRange;LineRange;37;0;Create;True;0;0;False;0;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;145;-2444.617,686.01;Float;False;Property;_VertexOffsetTexU;VertexOffsetTexU;55;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;143;-2441.618,763.009;Float;False;Property;_VertexOffsetTexV;VertexOffsetTexV;56;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;20;-2167.552,1042.946;Inherit;False;730.8218;342.6487;扭曲贴图影响顶点偏移;4;182;172;170;167;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.StaticSwitch;211;-3223.979,-164.0996;Float;False;Property;_SoftDissolveSwitch;SoftDissolveSwitch;26;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;181;-2633.671,130.7636;Float;False;Property;_DepthFadeIndensity;DepthFadeIndensity;6;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;229;-2524.453,369.1342;Float;False;Property;_Eagefade;Eagefade;8;0;Create;True;0;0;False;0;1;7;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;173;-4099.276,-1134.428;Float;False;Property;_DistortionInfluenceGradient;DistortionInfluenceGradient;5;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FresnelNode;235;-2330.033,268.9747;Inherit;True;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;236;-1942.033,279.9747;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;182;-1770.347,1091.901;Float;False;Property;_DistortionInfluenceOffset;DistortionInfluenceOffset;53;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;198;-2540.218,-546.0905;Float;False;Property;_LineColor;LineColor;39;1;[HDR];Create;True;0;0;False;0;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;189;-1588.167,646.5861;Inherit;True;Property;_VertexOffsetTex;VertexOffsetTex;54;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SaturateNode;231;-1609.55,311.7458;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;195;-2499.8,-376.2324;Float;False;Property;_LineIndensity;LineIndensity;40;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;213;-1609.913,-160.9695;Float;False;Property;_DepthFade;DepthFade;4;0;Create;True;0;0;False;0;0;0;0;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;197;-1264.64,797.983;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;230;-1397.488,187.3063;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;201;-1379.621,567.967;Float;False;Property;_VertexOffsetIndensity;VertexOffsetIndensity;57;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;216;-1225.188,66.54852;Float;False;Property;_EageFade;EageFade;7;0;Create;True;0;0;False;0;0;0;1;True;;Toggle;2;Key0;Key1;Create;False;9;1;FLOAT;0;False;0;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-771.0934,-55.19758;Float;False;True;-1;2;ASEMaterialInspector;0;0;Lambert;-----ASE------/Blend简化;False;False;False;False;True;True;True;True;True;True;True;True;False;False;False;False;False;False;False;False;False;Off;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Custom;;Transparent;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;2;5;False;-1;10;False;-1;0;0;False;-1;0;False;-1;1;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=9AEE3C853823D61C2E8980F8B8C3EBCDEC537A9F